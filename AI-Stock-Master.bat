...
REM uv run check_ollama_env.py  gemma3:1b
...
rem     ".venv\Scripts\pythonw.exe" gui-pyqt5.py
rem ) else if exist ".venv\Scripts\python.exe" (
rem     start /B ".venv\Scripts\python.exe" gui-pyqt5.py
rem ) else (
rem     start /B python gui-pyqt5.py
rem )
