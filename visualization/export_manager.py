...
try:
    ...
    class MockFigure:
        ...
        def write_image(self, *args, **kwargs):
            raise ImportError("Plotly未安装，无法导出图像")
        
        def to_json(self):
            return '{"error": "Plotly未安装"}'
    ...
    class MockPio:
        ...
        def to_html(*args, **kwargs):
            return "<div>Plotly未安装，无法生成图表</div>"
    
    go = MockGo()
    pio = MockPio()
    pyo = None
    PLOTLY_AVAILABLE = False
    print("WARNING: Plotly未安装，图表导出功能受限")
...
<body>
    ...
    <div class="footer">
        <p>© 2025 AI股票分析系统 | 本报告仅供参考，投资有风险，决策需谨慎</p>
    </div>
</body>
</html>
        """
...
class ReportImageGenerator:
    ...
    def create_summary_image(self, charts_data: Dict[str, Any], 
        ...
        if text_font:
            footer_text = "© 2025 AI股票分析系统 | 本报告仅供参考，投资有风险，决策需谨慎"
...
<body>
    <div class="dashboard-container">
        ...
        <footer class="dashboard-footer">
            <p>© 2025 AI股票分析系统 | 数据更新频率: 实时 | 建议使用Chrome浏览器获得最佳体验</p>
        </footer>
    </div>
