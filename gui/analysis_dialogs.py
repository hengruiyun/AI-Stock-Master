...
class AboutDialog:
    ...
    def setup_dialog(self):
        ...
        # 产品名称
        tk.Label(info_frame, text=t_gui('app_name', 'AI股票趋势分析系统'),
                font=('Microsoft YaHei', 11, 'bold'),
...
• {t_gui('historical_data_analysis', '历史数据分析')}"""
        ...
        # 版权信息
        copyright_text = f"""{t_gui('copyright_year', '© 2025')} {t_gui('app_name', 'AI股票趋势分析系统')}. {t_gui('all_rights_reserved', '保留所有权利')}.
