...
class DataUpdater:
    ...
    def __init__(self, parent=None):
        ...
        self.files_to_download = [
            {
                'url': 'https://github.com/hengruiyun/AI-Stock-Master/raw/refs/heads/main/CN_Demo800.json.gz',
                'filename': 'CN_Demo800.json.gz',
                'description': t_tools('cn_demo_desc')
            },
            {
                'url': 'https://github.com/hengruiyun/AI-Stock-Master/raw/refs/heads/main/HK_Demo300.json.gz',
                'filename': 'HK_Demo300.json.gz',
                'description': t_tools('hk_demo_desc')
            },
            {
                'url': 'https://github.com/hengruiyun/AI-Stock-Master/raw/refs/heads/main/US_Demo300.json.gz',
