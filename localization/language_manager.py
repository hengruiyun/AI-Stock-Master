    ...
    def _load_translations(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            'zh': {
                ...
                'app_version': 'v1.0',
                'welcome_title': '欢迎使用 AI股票趋势分析系统',
                'welcome_message': '请点击"打开文件"按钮选择Excel数据文件开始分析。\n\n支持格式：*.xlsx, *.xls\n包含股票代码、名称、行业、历史评级数据',
                ...
                'menu_exit': '退出',
                'menu_analysis': '分析',
                'menu_stock_analysis': '个股分析',
                'menu_industry_analysis': '行业分析',
                'menu_market_sentiment': '市场情绪',
                'menu_tools': '工具',
                'menu_data_validation': '数据验证',
                'menu_performance': '性能监控',
                'menu_settings': '设置',
                'menu_help': '帮助',
                'menu_help_content': '使用说明',
                'menu_about': '关于',
            ...
            'en': {
                ...
                'app_version': 'v1.0',
                'welcome_title': 'Welcome to AI Stock Trend Analysis System',
                'welcome_message': 'Click "Open File" to select Excel data file to start analysis.\n\nSupported formats: *.xlsx, *.xls\nContains: stock code, name, industry, historical rating data',
                ...
                'menu_stock_analysis': 'Stock Analysis',
                'menu_industry_analysis': 'Industry Analysis',
                'menu_market_sentiment': 'Market Sentiment',
                'menu_tools': 'Tools',
                'menu_data_validation': 'Data Validation',
                'menu_performance': 'Performance Monitor',
                'menu_settings': 'Settings',
                'menu_help': 'Help',
                'menu_help_content': 'User Guide',
                'menu_about': 'About',
